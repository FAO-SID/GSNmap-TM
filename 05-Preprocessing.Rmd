...
The spreadsheet with soil physical data contains data on soil texture for clay (clay_0_30, in g/kg), silt (silt_0_30, in g/kg), and sand (sand_0_30, in g/kg) (see Table \@ref(tab:table2_2)).

```{r table2_2, echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
